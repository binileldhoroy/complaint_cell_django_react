                ...
                <Col md={9}>
                  ...
                  >
                    <Form.Control
                      ...
                      readOnly
                      value={
                        (userInfo.people && userInfo.people.first_name) ||
                        (userInfo.people && userInfo.people.people.first_name)
                      }
                ...
                <Col md={9}>
                  ...
                  >
                    <Form.Control
                      ...
                      readOnly
                      value={
                        (userInfo.people && userInfo.people.last_name) ||
                        (userInfo.people && userInfo.people.people.last_name)
                      }
                ...
                <Col md={9}>
                  ...
                  >
                    <Form.Control
                      ...
                      readOnly
                      value={
                        (userInfo.people && userInfo.people.email) ||
                        (userInfo.people && userInfo.people.people.email)
                      }
                  ...
                  >
                    <Form.Control
                      ...
                      value={
                        ...
                        (userInfo.people && userInfo.people.phone)
                      }
                ...
                <Col md={6} className="row">
                  ...
                  <Col md={8}>
                    <Form.Select
                      ...
                      defaultValue={
                        userInfo && userInfo.relative_type
                          ? userInfo.relative_type
                          : ""
                      }
                      aria-label="Default select example"
                    >
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        type="text"
                        defaultValue={
                          userInfo.relative_name ? userInfo.relative_name : ""
                        }
                        {...register("relative")}
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        ...
                        {...register("id_number")}
                        defaultValue={
                          userInfo.proof_number ? userInfo.proof_number : ""
                        }
                ...
                <Col md={6} className="row">
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        type="text"
                        defaultValue={
                          userInfo.house_name ? userInfo.house_name : ""
                        }
                        {...register("house_name")}
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        type="text"
                        defaultValue={
                          userInfo.house_number ? userInfo.house_number : ""
                        }
                        {...register("house_no")}
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        type="text"
                        defaultValue={userInfo.street ? userInfo.street : ""}
                        {...register("street")}
                        placeholder="Street"
                      />
                    </Form.Group>
                  ...
                  <Col md={8}>
                    {userInfo && userInfo.pin_code ? (
                      ...
                      >
                        <Form.Control
                          type="text"
                          value={userInfo.pin_code ? userInfo.pin_code : ""}
                          {...register("pin_code")}
                          placeholder="Pincode"
                        />
                      </Form.Group>
                      ...
                      >
                        ...
                        <Button
                          className="mt-1"
                          onClick={() => searchPostOffice(pinCode)}
                          variant="contained"
                          endIcon={<SearchIcon />}
                        >
                          Search
                  ...
                  <Col md={8}>
                    {userInfo && userInfo.country ? (
                      ...
                      >
                        <Form.Control
                          type="text"
                          value={pincodeDetails[0] && pincodeDetails[0].Country}
                          {...register("country")}
                          placeholder="Country"
                        />
                      </Form.Group>
                  ...
                  <Col md={8}>
                    {userInfo && userInfo.state ? (
                      ...
                      >
                        <Form.Control
                          type="text"
                          value={pincodeDetails[0] && pincodeDetails[0].State}
                          {...register("state")}
                          placeholder="State"
                        />
                      </Form.Group>
                  ...
                  <Col md={8}>
                    {userInfo && userInfo.police_district ? (
                      ...
                      >
                        <Form.Control
                          type="text"
                          value={userInfo && userInfo.police_district}
                          {...register("ps_district")}
                      ...
                      >
                        <Form.Control
                          type="text"
                          value={
                            pincodeDetails[0] && pincodeDetails[0].District
                          }
                          {...register("ps_district")}
                          placeholder="Police District"
                        />
                  ...
                  <Col md={8}>
                    ...
                    >
                      <Form.Control
                        type="text"
                        defaultValue={
                          userInfo.police_station ? userInfo.police_station : ""
                        }
                        {...register("ps_station")}
